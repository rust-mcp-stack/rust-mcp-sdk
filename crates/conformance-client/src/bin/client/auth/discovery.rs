...
//!
//! Probes the MCP server with an unauthenticated `server/discover` request
//! to pull the `WWW-Authenticate` challenge, then runs the SDK's combined
...
async fn probe_www_authenticate(
    ...
    let resp = http
        ...
        .json(&serde_json::json!({
            ...
            "params": {
                "_meta": {
                    "io.modelcontextprotocol/protocolVersion": rust_mcp_sdk::schema::LATEST_PROTOCOL_VERSION,
