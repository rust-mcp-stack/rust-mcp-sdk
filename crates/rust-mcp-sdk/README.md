...
```toml
[dependencies]
rust-mcp-sdk = "1.0.2"  # Check crates.io for the latest version
```
...
```toml
[dependencies]
rust-mcp-sdk = { version = "1.0.2", default-features = false, features = ["server","macros","stdio"] }
```
...
```toml
[dependencies]
rust-mcp-sdk = { version = "1.0.2", default-features = false, features = ["client","stdio"] }
```
