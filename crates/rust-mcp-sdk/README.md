...
- OAuth Authentication for MCP Servers
  - [Remote Oauth Provider](src/auth/auth_provider/remote_auth_provider.rs)
    - **Keycloak** Provider (via [rust-mcp-extra](../rust-mcp-extra/README.md#keycloak))
    - **WorkOS** Authkit Provider (via [rust-mcp-extra](../rust-mcp-extra/README.md#workos-authkit))
    - **Scalekit** Authkit Provider (via [rust-mcp-extra](../rust-mcp-extra/README.md#scalekit))
...
|---|---|---|
| Axum | `mcp_routes(state, &mount_opts, http_handler)` | [`rust-mcp-axum` README](../rust-mcp-axum/README.md) |
| Actix-web | `mcp_scope(state, http_handler, &mount_opts)` | [`rust-mcp-actix` README](../rust-mcp-actix/README.md) |
...
impl ClientHandler for MyClientHandler {
    ...
    // See: src/mcp_handlers/mcp_client_handler.rs
}
...
For more examples (stdio, Streamable HTTP, clients, auth, etc.), see the [examples/](examples/) directory.
...
See the [hello-world-mcp-server-stdio](examples/hello-world-mcp-server-stdio.rs) example running in the [MCP Inspector](https://modelcontextprotocol.io/docs/tools/inspector):
...
### RemoteAuthProvider
[RemoteAuthProvider](src/mcp_http/auth/auth_provider/remote_auth_provider.rs) enables authentication with identity providers that support Dynamic Client Registration (DCR), letting MCP clients auto-register and obtain credentials.
